# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 06:51:20 2021
...
def loaddata(fileName):
    ...
    pickle_name = fileName.split(".")
    file = open('../pickle/'+pickle_name[0] + ".pickle", 'wb')
...
if __name__ == "__main__":
    loaddata('../dataset/13_test.binetflow')